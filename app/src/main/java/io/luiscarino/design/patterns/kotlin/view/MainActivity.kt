...
import io.luiscarino.design.patterns.kotlin.view.list.ListFragment
        ...
        when (item.itemId) {
            R.id.navigation_behavioral -> {
                supportFragmentManager.beginTransaction()
                        .replace(R.id.fragmentContainer, ListFragment.newInstance(BehavioralPatterns.ITEMS))
                        .commit()
                return@OnNavigationItemSelectedListener true
            }
            R.id.navigation_creational -> {
                supportFragmentManager.beginTransaction()
                        .replace(R.id.fragmentContainer, ListFragment.newInstance(CreationalPatterns.ITEMS))
                        .commit()
                return@OnNavigationItemSelectedListener true
            }
            R.id.navigation_structural -> {
                supportFragmentManager.beginTransaction()
                        .replace(R.id.fragmentContainer, ListFragment.newInstance(StructuralPatterns.ITEMS))
                        .commit()
                return@OnNavigationItemSelectedListener true
