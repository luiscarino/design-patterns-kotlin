...
import io.luiscarino.design.patterns.kotlin.view.list.ListFragment.OnListFragmentInteractionListener
 ...
 */
class ListFragmentViewAdapter(
        private val mValues: List<String>,
        private val mListener: OnListFragmentInteractionListener?)
    : RecyclerView.Adapter<ListFragmentViewAdapter.ViewHolder>() {
